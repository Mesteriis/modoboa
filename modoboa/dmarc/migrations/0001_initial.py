    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=4,
                        choices=[(b'dkim', b'DKIM'), (b'spf', b'SPF')],
                    ),
                ),
                ...
                (
                    'record',
                    models.ForeignKey(
                        to='dmarc.Record', on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='dmarc.Reporter', on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='report', unique_together={('reporter', 'report_id')}
        ),
        migrations.AddField(
            model_name='record',
            name='report',
            field=models.ForeignKey(
                to='dmarc.Report', on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
    ]
